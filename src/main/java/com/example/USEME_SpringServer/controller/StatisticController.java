...
public class StatisticController {
    ...
    @GetMapping
    public List<Statistic> getAllStatistics(@RequestParam(name = "student_id") Long studentId,
                                            @RequestParam(name = "homework_id") Long homeworkId,
                                            @RequestParam(name = "task_id") Long taskId) {
        return statisticService.getAllStatistics(studentId, homeworkId, taskId);
    }

    @GetMapping("/statistic")
    public Statistic getStatistic(@RequestParam(name = "student_id") Long studentId,
                                  @RequestParam(name = "homework_id") Long homeworkId,
                                  @RequestParam(name = "task_id") Long taskId) {
